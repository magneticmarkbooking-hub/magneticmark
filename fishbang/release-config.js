...
const RELEASE = {
  ...
  coverRaw: "https://magneticmarkdj.com/fishbang/cover.jpg",
  ...
  // Opis do meta tagów
  description: "Listen to \"Fish Bang\", the new single from MagneticMark. Peak Time Techno with live trumpet energy."
};
