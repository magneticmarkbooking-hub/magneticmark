...
function initBgOrbs() {
  const colors = ['rgba(204,72,0,0.55)', 'rgba(255,96,0,0.45)', 'rgba(255,147,51,0.3)'];
...
function initCustomCursor() {
  ...
  function drawTrail() {
    ...
    for (let i = 0; i < points.length; i++) {
      ...
      grad.addColorStop(0, 'rgba(255,150,60,' + (p.life * 0.55) + ')');
      grad.addColorStop(1, 'rgba(204,72,0,0)');
      ctx.fillStyle = grad;
...
function submitEmailPopup() {
  ...
  msg.style.color = 'rgba(204,184,168,0.6)';
